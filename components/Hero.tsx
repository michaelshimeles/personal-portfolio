...
const Hero = ({ }) => {
    return (
        <div className='md:flex items-center gap-5 sm:w-[80%] md:w-[60%] lg:w-[50%] p-4'>
            <Image src="/pfp2.jpg" width={150} height={150} alt='profile picture' className='rounded-full border-4' />
            <div>
