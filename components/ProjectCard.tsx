...
const ProjectCard: React.FC<ProjectCardProps> = ({ image, title, description, urls }) => {
    ...
    return (
        <div className='flex flex-col lg:flex-row mt-[2rem] justify-start items-between gap-4'>
            <Image src={image} width={300} height={100} alt='starter' className='rounded-md drop-shadow-xl' />
